      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-6 text-center">
        ...
        <div className={`transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
          ...
          <h1 className="text-5xl md:text-7xl font-800 leading-tight mb-6 tracking-tight" style={{ fontWeight: 800 }}>
            <span style={{ color: 'var(--text-primary)' }}>Custom ERP</span>
            <br />
        ...
        {/* CTA */}
        <div className={`flex items-center gap-4 mb-16 transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
        ...
        {/* Stats */}
        <div className={`grid grid-cols-2 md:grid-cols-4 gap-6 max-w-2xl w-full transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
